...
export class EventEditComponent implements OnInit {
  ...
  constructor(public activeModal: NgbActiveModal, private eventService: EventCrudService, private eventTypeService: EventTypeService, private messageService: MessageService, public datePipe: DatePipe, private fb: FormBuilder, private toastService: ToastService) {
